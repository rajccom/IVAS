...
<body style="*background:url(gg.jpg) no-repeat top center;">
					...
					<div class="header-item-center">
						...
						<nav class="menu">
							...
							<ul class="menu-section">
								...
								<li><a href="#">DESIGNGER <br>HARDWARE</a></li>
							</ul>
						</nav>
					</div>
...
<div class="container"><a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
